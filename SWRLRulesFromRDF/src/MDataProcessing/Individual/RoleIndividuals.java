...
public class RoleIndividuals 
{
    ...
    /**
     * Add the role individual to the list of individuals. And then add his inversion (domain is the range and range is the domain) to the list of invert individuals.
