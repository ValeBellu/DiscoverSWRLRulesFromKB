...
public class Pattern
{
    ...
    public Pattern(Atom headAtomInput)
    {
        ...
        {
            //add the head atom to the list of atoms
            this.listAtoms.add(new RoleAtom(headAtomInput.getIRI(), 
            		((RoleAtom) headAtomInput).getDomainVariable(),
            		((RoleAtom) headAtomInput).getRangeVariable()));
            this.headAtom = new RoleAtom(headAtomInput.getIRI(), 
            		((RoleAtom) headAtomInput).getDomainVariable(), 
            		((RoleAtom) headAtomInput).getRangeVariable());
    ...
    public boolean adjustPattern()
    {
       ...
       // System.out.println("Finito di aggiustare");
        return false;
