...
/**
 *
 * Class which manages the population. 
 */
public class Population 
{
    ...
    {        
        ...
        System.out.println("The list of individuals is composed by " + listIndividuals.size() + " patterns.");
    ...
    public boolean isPatternExist(Pattern pattern)
    {
        ...
        {
            if (this.listIndividuals.get(i).equals(pattern))
                return true;
        }
        return false;            
    }
