...
//            if (numberRandom <= 50)
//            {
//                population = generateNewGenerationByCrossover(population);
//                System.out.println("Crossover the generation: " + i);
//            }
//           
//        }
//        
...
//                if(newListPatterns.contains(patternCrossOver1.get(j))) {
//                	acceptAdd = false;
//                	break;
//                }
                ...
                for(int k = 0; k < newListPatterns.size(); k++)
                {
                    ...
                    if (newListPatterns.get(k).equals(patternCrossOver1.get(j)))                
                    {
                        acceptAdd = false;
                        break;
                    }
                ...
                if (acceptAdd) 
                {
                    ...
                    if (numberRandom <= 5)
                    {
                    //	System.out.println("Mutazione pattern 1");
                        Pattern patternMutation = mutation(patternCrossOver1.get(j));
                     //   System.out.println("Fine mutazione");
//                        if (newListPatterns.contains(patternMutation)) {
//                        	acceptAdd = false;
//                        	break;
//                        }
                        for(int k = 0; k < newListPatterns.size(); k++)
         ...
         //   System.out.println("Finito pattern figlio 1");
         //   System.out.println("Size 2: " + patternCrossOver1.size());
            for(int j=0; j<patternCrossOver2.size(); j++)
            {
                boolean acceptAdd = true;
//                if(newListPatterns.contains(patternCrossOver2.get(j))) {
//                	acceptAdd = false;
//                	break;
//                }
                ...
                for(int k = 0; k < newListPatterns.size(); k++)
                {
                    if (newListPatterns.get(k).equals(patternCrossOver2.get(j)))                
                    {
                        acceptAdd = false;
                        break;
                    }
                ...
                {	
                 ...
                 //   	System.out.println("Mutazione pattern 2");
...
//                        }
                        for(int k = 0; k < newListPatterns.size(); k++)
                        {
                            if ( newListPatterns.get(k).equals(patternMutation))                
                            {
                                acceptAdd = false;
                                break;
                            }
           ...
           // System.out.println("Finito pattern figlio 2");
        }
    ...
    public Pattern mutation(Pattern pattern)
    {
        ...
        //the fitness value of the pattern is above a given threshold (0,2)
        if (pattern.getPatternComputation().getFitnessValue() > Global.MUTATION_THR)
        {
        ...
        //the fitness value is greater than the threshold
